...
export default function CreateGameModal({ onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showError(error?.message || 'Tạo game thất bại');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <Card className="max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-primary-700/20">
          <div>
            <h2 className="text-2xl font-bold text-white">Thêm Game Mới</h2>
            <p className="text-sm text-gray-400 mt-1">Thêm game esports mới vào hệ thống</p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="md:col-span-1">
              ...
              <input
                ...
                placeholder="VD: League of Legends"
              />
              {errors.game_name && (
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                placeholder="Nhập mô tả về game (tùy chọn)"
              />
            </div>
          </div>
